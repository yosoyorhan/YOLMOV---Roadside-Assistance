...
export const MOCK_PARTNER_REQUESTS: JobRequest[] = [
  {
    id: 'REQ-101',
    serviceType: 'Çekici Hizmeti',
    location: 'Maslak, Sarıyer',
    dropoffLocation: 'Oto Sanayi, Levent',
    distance: '3.2 km',
    price: 850,
    timestamp: 'Az önce',
    customerName: 'Can B.',
    vehicleInfo: '2020 BMW 3.20i',
    urgency: 'high',
    expiresIn: 120
  },
  {
    ...
    location: 'Akmerkez AVM Otoparkı',
    distance: '1.5 km',
    price: 400,
    timestamp: '4 dk önce',
    customerName: 'Ayşe K.',
    vehicleInfo: '2018 Fiat Egea',
    urgency: 'normal',
    expiresIn: 300
  },
  {
    id: 'REQ-103',
    serviceType: 'Lastik Değişimi',
    location: 'Fatih Sultan Mehmet Köprüsü Çıkışı',
    distance: '8.0 km',
    price: 600,
    timestamp: '8 dk önce',
